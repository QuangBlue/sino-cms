    ...
    <Box>
      ...
      <form onSubmit={handleSubmit(onSubmit)} id='speaker-form'>
        {fields.map((item, index) => {
          return <OrganiserPartnersAdd key={item.id} index={index} control={control} errors={errors} remove={remove} />
        })}
      </form>
    </Box>
  )
...
export default OrganiserPartners
